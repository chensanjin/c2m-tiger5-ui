 ...
 * @LastEditTime: 2021-08-23 10:08:53
    ...
    <div class="footer-content">
      <div class="footer-content-leader">
        <el-row :getter="10">
          ...
          <el-col v-if="userList.supervisor" :span="20">{{
            userList.supervisor.nickName
          }}</el-col>
        </el-row>
      </div>
      <div class="footer-content-operators">
        ...
        <div
          v-for="item in userList.operators"
          :key="item.id"
          class="footer-content-operator-item"
        >
          {{ item.nickName }}
        </div>
        <!-- <div> -->
...
.footer-wrap {
  ...
  .footer-content-operators {
    display: flex;
    align-items: center;
    width: 100%;
    .footer-content-operator-item {
      margin-left: 10px;
    }
  }
  .footer-content {
