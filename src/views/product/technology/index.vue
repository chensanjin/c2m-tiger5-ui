<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['product:technology:add']"
          type="primary"
          plain
          icon="el-icon-plus"
          size="mini"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['product:technology:edit']"
          type="success"
          plain
          icon="el-icon-edit"
          size="mini"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['product:technology:remove']"
          type="danger"
          plain
          icon="el-icon-delete"
          size="mini"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['product:technology:export']"
          type="warning"
          plain
    ...
    <el-table v-loading="loading" :data="technologyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编码" align="center" prop="technologyCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="工艺编码" prop="technologyCode">
          <el-input v-model="form.technologyCode" placeholder="请输入工艺编码" />
        </el-form-item>
        <el-form-item label="工艺名称" prop="technologyName">
...
<script>
import { listTechnology, getTechnology, delTechnology, addTechnology, updateTechnology, exportTechnology } from '@/api/product/technology'
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除工艺管理编号为"' + ids + '"的数据项?', '警告', {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有工艺管理数据项?', '警告', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
        this.exportLoading = true
        return exportTechnology(queryParams)
      }).then(response => {
