    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column v-if="columns[4].visible" key="workshopName" label="车间" align="center" prop="workshopName" :show-overflow-tooltip="true" />
